...
if($global:SPSGlobalsSet -ne $true)									# A check to keep other scripts from repeating global configuration.
{
    ...
    $global:Workitem    		= [PSObject] $null					# The workitem.  Only will be valid while the sequence automation is being run.
	...
	. .\Functions.ps1
	. .\ErrorManagement.ps1
    . .\SPSiteMigration-UpdateWorkItemStateManual.ps1
    . .\SPSiteMigration-SPOSitesProvisioning.ps1
